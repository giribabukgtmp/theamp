...
(function( $, window, document, undefined ) {
	var Slider = {
		...
		init: function( options, elem ) {
			...
			$('.coda-slider').prepend('<p class="loading">Loading...</p>');
		...
		build: function() {
			...
			$(self.sliderId + " > div.coda-slider-bgr").addClass('panel');
			 if ($(self.sliderId).hasClass("full-width")) {
				$(self.sliderId + " > div.coda-slider-bgr").css('width', $(window).width());
				$(self.sliderId).css('width', $(window).width());
			}
